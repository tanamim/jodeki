...
###### Better Search
We want to provide better search functions by ads-free private information retrieval. Since most public web services implement ads for monetization at the expence of contents quality, the Internet search results can be skewed towards ads. Our aim is to remove ads to provide high quality information from private sources with little fees and make Internet search more efficient. We designed strong reward system to encourage users to provide knowledge at their best.
